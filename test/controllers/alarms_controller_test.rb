...
class AlarmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alarm" do
    assert_difference('Alarm.count') do
      post alarms_url, params: { alarm: { description: @alarm.description, vote_counter: @alarm.vote_counter } }
    end
  ...
  test "should update alarm" do
    patch alarm_url(@alarm), params: { alarm: { description: @alarm.description, vote_counter: @alarm.vote_counter } }
